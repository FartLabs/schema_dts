...
import type { SchemaOrg_Energy } from "labs/SchemaOrg_Energy.ts";
import type { SchemaOrg_Number } from "labs/SchemaOrg_Number.ts";
import type { SchemaOrg_PhysicalActivity } from "labs/SchemaOrg_PhysicalActivity.ts";
 ...
 */
export const SCHEMA_ORG_ExercisePlan = "https://schema.org/ExercisePlan" as const;

/**
 * Fitness-related activity designed for a specific health-related purpose, including defined exercise routines as well as activity prescribed by a clinician.
 * @see https://schema.org/ExercisePlan
 */
export interface SchemaOrg_ExercisePlan extends SchemaOrg_CreativeWork, SchemaOrg_PhysicalActivity {
    /**
