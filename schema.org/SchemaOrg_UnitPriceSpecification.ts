...
import type { SchemaOrg_PriceComponentTypeEnumeration } from "./SchemaOrg_PriceComponentTypeEnumeration.ts";
 ...
 */
export const SCHEMA_ORG_UnitPriceSpecification =
  "https://schema.org/UnitPriceSpecification" as const;

/**
 * The price asked for a given offer by the respective organization or person.
 * @see https://schema.org/UnitPriceSpecification
 */
export interface SchemaOrg_UnitPriceSpecification
  ...
  billingDuration?: Array<
    SchemaOrg_Number | SchemaOrg_QuantitativeValue | SchemaOrg_Duration
  >;
  /**
