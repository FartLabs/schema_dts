 ...
 */
export const SCHEMA_ORG_InvestmentOrDeposit = "https://schema.org/InvestmentOrDeposit" as const;

/**
 * A type of financial product that typically requires the client to transfer funds to a financial service in return for potential beneficial financial return.
 * @see https://schema.org/InvestmentOrDeposit
 */
export interface SchemaOrg_InvestmentOrDeposit extends SchemaOrg_FinancialProduct {
    /**
     * The amount of money.
