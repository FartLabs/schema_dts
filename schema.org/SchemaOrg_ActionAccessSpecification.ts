 ...
 */
export const SCHEMA_ORG_ActionAccessSpecification =
  "https://schema.org/ActionAccessSpecification" as const;

/**
 * A set of requirements that must be fulfilled in order to perform an Action.
 * @see https://schema.org/ActionAccessSpecification
 */
export interface SchemaOrg_ActionAccessSpecification
