 ...
 */
export const SCHEMA_ORG_OpeningHoursSpecification =
  "https://schema.org/OpeningHoursSpecification" as const;
 ...
 * @see https://schema.org/OpeningHoursSpecification
 */
export interface SchemaOrg_OpeningHoursSpecification
