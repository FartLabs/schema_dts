...
import type { SchemaOrg_ActionAccessSpecification } from "labs/SchemaOrg_ActionAccessSpecification.ts";
 ...
 */
export const SCHEMA_ORG_ConsumeAction = "https://schema.org/ConsumeAction" as const;
