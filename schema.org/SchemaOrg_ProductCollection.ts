...
import type { SchemaOrg_Collection } from "labs/SchemaOrg_Collection.ts";
 ...
 */
export const SCHEMA_ORG_ProductCollection = "https://schema.org/ProductCollection" as const;

/**
 * A set of products (either [[ProductGroup]]s or specific variants) that are listed together e.g. in an [[Offer]].
 * @see https://schema.org/ProductCollection
 */
export interface SchemaOrg_ProductCollection extends SchemaOrg_Collection, SchemaOrg_Product {
    /**
