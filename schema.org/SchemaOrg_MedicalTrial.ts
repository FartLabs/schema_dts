...
import type { SchemaOrg_MedicalTrialDesign } from "./SchemaOrg_MedicalTrialDesign.ts";
 ...
 */
export const SCHEMA_ORG_MedicalTrial =
  "https://schema.org/MedicalTrial" as const;
