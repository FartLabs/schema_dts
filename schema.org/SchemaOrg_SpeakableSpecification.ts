...
import type { SchemaOrg_CssSelectorType } from "labs/SchemaOrg_CssSelectorType.ts";
import type { SchemaOrg_Intangible } from "labs/SchemaOrg_Intangible.ts";
import type { SchemaOrg_XPathType } from "labs/SchemaOrg_XPathType.ts";

/**
 * A SpeakableSpecification indicates (typically via [[xpath]] or [[cssSelector]]) sections of a document that are highlighted as particularly [[speakable]]. Instances of this type are expected to be used primarily as values of the [[speakable]] property.
 * @see https://schema.org/SpeakableSpecification
 */
export const SCHEMA_ORG_SpeakableSpecification = "https://schema.org/SpeakableSpecification" as const;
