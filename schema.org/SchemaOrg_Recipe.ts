...
import type { SchemaOrg_HowTo } from "labs/SchemaOrg_HowTo.ts";
import type { SchemaOrg_ItemList } from "labs/SchemaOrg_ItemList.ts";
import type { SchemaOrg_NutritionInformation } from "labs/SchemaOrg_NutritionInformation.ts";
import type { SchemaOrg_QuantitativeValue } from "labs/SchemaOrg_QuantitativeValue.ts";
import type { SchemaOrg_RestrictedDiet } from "labs/SchemaOrg_RestrictedDiet.ts";
...
export interface SchemaOrg_Recipe extends SchemaOrg_HowTo {
     ...
     */
    recipeInstructions: Array<SchemaOrg_CreativeWork | SchemaOrg_ItemList | SchemaOrg_Text>;
    /**
