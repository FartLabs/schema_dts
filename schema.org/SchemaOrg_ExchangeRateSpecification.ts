 ...
 */
export const SCHEMA_ORG_ExchangeRateSpecification =
  "https://schema.org/ExchangeRateSpecification" as const;

/**
 * A structured value representing exchange rate.
 * @see https://schema.org/ExchangeRateSpecification
 */
export interface SchemaOrg_ExchangeRateSpecification
