...
import type { SchemaOrg_Order } from "labs/SchemaOrg_Order.ts";
...
import type { SchemaOrg_PaymentStatusType } from "labs/SchemaOrg_PaymentStatusType.ts";
...
export interface SchemaOrg_Invoice extends SchemaOrg_Intangible {
     ...
     */
    minimumPaymentDue: Array<SchemaOrg_PriceSpecification | SchemaOrg_MonetaryAmount>;
    /**
     ...
     */
    totalPaymentDue: Array<SchemaOrg_PriceSpecification | SchemaOrg_MonetaryAmount>;
}
