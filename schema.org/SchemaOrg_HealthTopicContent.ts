...
import type { SchemaOrg_HealthAspectEnumeration } from "labs/SchemaOrg_HealthAspectEnumeration.ts";
 ...
 */
export const SCHEMA_ORG_HealthTopicContent = "https://schema.org/HealthTopicContent" as const;
