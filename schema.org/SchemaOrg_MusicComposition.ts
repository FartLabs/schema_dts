...
import type { SchemaOrg_MusicComposition } from "labs/SchemaOrg_MusicComposition.ts";
 ...
 */
export const SCHEMA_ORG_MusicComposition = "https://schema.org/MusicComposition" as const;
