 ...
 */
export const SCHEMA_ORG_LegislationObject =
  "https://schema.org/LegislationObject" as const;

/**
 * A specific object or file containing a Legislation. Note that the same Legislation can be published in multiple files. For example, a digitally signed PDF, a plain PDF and an HTML version.
 * @see https://schema.org/LegislationObject
 */
export interface SchemaOrg_LegislationObject
  extends SchemaOrg_Legislation, SchemaOrg_MediaObject {
  /**
