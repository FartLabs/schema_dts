 ...
 */
export const SCHEMA_ORG_SpecialAnnouncement =
  "https://schema.org/SpecialAnnouncement" as const;
...
export interface SchemaOrg_SpecialAnnouncement extends SchemaOrg_CreativeWork {
  ...
  announcementLocation?: Array<
    SchemaOrg_CivicStructure | SchemaOrg_LocalBusiness
  >;
  /**
  ...
  diseaseSpreadStatistics?: Array<
    | SchemaOrg_URL
    | SchemaOrg_WebContent
    | SchemaOrg_Observation
    | SchemaOrg_Dataset
  >;
  /**
