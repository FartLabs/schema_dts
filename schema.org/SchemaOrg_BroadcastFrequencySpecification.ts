 ...
 */
export const SCHEMA_ORG_BroadcastFrequencySpecification = "https://schema.org/BroadcastFrequencySpecification" as const;

/**
 * The frequency in MHz and the modulation used for a particular BroadcastService.
 * @see https://schema.org/BroadcastFrequencySpecification
 */
export interface SchemaOrg_BroadcastFrequencySpecification extends SchemaOrg_Intangible {
    /**
