...
import type { SchemaOrg_CourseInstance } from "./SchemaOrg_CourseInstance.ts";
...
import type { SchemaOrg_Syllabus } from "./SchemaOrg_Syllabus.ts";
 ...
 * @see https://schema.org/Course
 */
export interface SchemaOrg_Course
  extends SchemaOrg_LearningResource, SchemaOrg_CreativeWork {
  /**
  ...
  coursePrerequisites?: Array<
    SchemaOrg_Text | SchemaOrg_AlignmentObject | SchemaOrg_Course
  >;
  /**
  ...
  educationalCredentialAwarded?: Array<
    SchemaOrg_URL | SchemaOrg_EducationalOccupationalCredential | SchemaOrg_Text
  >;
  /**
