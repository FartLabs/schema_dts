...
import type { SchemaOrg_Diet } from "./SchemaOrg_Diet.ts";
import type { SchemaOrg_Distance } from "./SchemaOrg_Distance.ts";
import type { SchemaOrg_ExercisePlan } from "./SchemaOrg_ExercisePlan.ts";
...
import type { SchemaOrg_SportsEvent } from "./SchemaOrg_SportsEvent.ts";
import type { SchemaOrg_SportsTeam } from "./SchemaOrg_SportsTeam.ts";
 ...
 */
export const SCHEMA_ORG_ExerciseAction =
  "https://schema.org/ExerciseAction" as const;
