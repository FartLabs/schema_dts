 ...
 */
export const SCHEMA_ORG_MedicalRiskEstimator =
  "https://schema.org/MedicalRiskEstimator" as const;

/**
 * Any rule set or interactive tool for estimating the risk of developing a complication or condition.
 * @see https://schema.org/MedicalRiskEstimator
 */
export interface SchemaOrg_MedicalRiskEstimator
  extends SchemaOrg_MedicalEntity {
  /**
