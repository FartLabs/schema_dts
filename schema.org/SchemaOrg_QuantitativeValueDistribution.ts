 ...
 */
export const SCHEMA_ORG_QuantitativeValueDistribution = "https://schema.org/QuantitativeValueDistribution" as const;

/**
 * A statistical distribution of values.
 * @see https://schema.org/QuantitativeValueDistribution
 */
export interface SchemaOrg_QuantitativeValueDistribution extends SchemaOrg_StructuredValue {
    /**
