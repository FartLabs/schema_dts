 ...
 */
export const SCHEMA_ORG_EducationalOccupationalCredential = "https://schema.org/EducationalOccupationalCredential" as const;

/**
 * An educational or occupational credential. A diploma, academic degree, certification, qualification, badge, etc., that may be awarded to a person or other entity that meets the requirements defined by the credentialer.
 * @see https://schema.org/EducationalOccupationalCredential
 */
export interface SchemaOrg_EducationalOccupationalCredential extends SchemaOrg_CreativeWork {
    /**
     ...
     */
    credentialCategory?: Array<SchemaOrg_Text | SchemaOrg_DefinedTerm | SchemaOrg_URL>;
    /**
