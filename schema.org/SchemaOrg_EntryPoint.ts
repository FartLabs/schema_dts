...
import type { SchemaOrg_DigitalPlatformEnumeration } from "labs/SchemaOrg_DigitalPlatformEnumeration.ts";
...
export interface SchemaOrg_EntryPoint extends SchemaOrg_Intangible {
     ...
     */
    actionPlatform: Array<SchemaOrg_DigitalPlatformEnumeration | SchemaOrg_Text | SchemaOrg_URL>;
    /**
     * An application that can complete the request.
