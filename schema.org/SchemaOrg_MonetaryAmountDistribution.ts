 ...
 */
export const SCHEMA_ORG_MonetaryAmountDistribution =
  "https://schema.org/MonetaryAmountDistribution" as const;

/**
 * A statistical distribution of monetary amounts.
 * @see https://schema.org/MonetaryAmountDistribution
 */
export interface SchemaOrg_MonetaryAmountDistribution
  extends SchemaOrg_QuantitativeValueDistribution {
  /**
