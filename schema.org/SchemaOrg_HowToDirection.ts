 ...
 */
export const SCHEMA_ORG_HowToDirection = "https://schema.org/HowToDirection" as const;

/**
 * A direction indicating a single action to do in the instructions for how to achieve a result.
 * @see https://schema.org/HowToDirection
 */
export interface SchemaOrg_HowToDirection extends SchemaOrg_ListItem, SchemaOrg_CreativeWork {
    /**
