 ...
 */
export const SCHEMA_ORG_HowToSection = "https://schema.org/HowToSection" as const;

/**
 * A sub-grouping of steps in the instructions for how to achieve a result (e.g. steps for making a pie crust within a pie recipe).
 * @see https://schema.org/HowToSection
 */
export interface SchemaOrg_HowToSection extends SchemaOrg_ListItem, SchemaOrg_CreativeWork, SchemaOrg_ItemList {
    /**
