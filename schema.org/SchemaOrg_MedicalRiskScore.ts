 ...
 */
export const SCHEMA_ORG_MedicalRiskScore = "https://schema.org/MedicalRiskScore" as const;

/**
 * A simple system that adds up the number of risk factors to yield a score that is associated with prognosis, e.g. CHAD score, TIMI risk score.
 * @see https://schema.org/MedicalRiskScore
 */
export interface SchemaOrg_MedicalRiskScore extends SchemaOrg_MedicalRiskEstimator {
    /**
