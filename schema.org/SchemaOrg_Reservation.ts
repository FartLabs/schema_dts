...
import type { SchemaOrg_ReservationStatusType } from "./SchemaOrg_ReservationStatusType.ts";
import type { SchemaOrg_Text } from "./SchemaOrg_Text.ts";
import type { SchemaOrg_Thing } from "./SchemaOrg_Thing.ts";
import type { SchemaOrg_Ticket } from "./SchemaOrg_Ticket.ts";
...
export interface SchemaOrg_Reservation extends SchemaOrg_Intangible {
   ...
   */
  totalPrice?: Array<
    SchemaOrg_Text | SchemaOrg_Number | SchemaOrg_PriceSpecification
  >;
  /**
