 ...
 */
export const SCHEMA_ORG_RepaymentSpecification = "https://schema.org/RepaymentSpecification" as const;

/**
 * A structured value representing repayment.
 * @see https://schema.org/RepaymentSpecification
 */
export interface SchemaOrg_RepaymentSpecification extends SchemaOrg_StructuredValue {
    /**
