 ...
 */
export const SCHEMA_ORG_MobileApplication = "https://schema.org/MobileApplication" as const;

/**
 * A software application designed specifically to work well on a mobile device such as a telephone.
 * @see https://schema.org/MobileApplication
 */
export interface SchemaOrg_MobileApplication extends SchemaOrg_SoftwareApplication {
    /**
