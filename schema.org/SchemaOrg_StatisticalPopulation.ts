 ...
 */
export const SCHEMA_ORG_StatisticalPopulation = "https://schema.org/StatisticalPopulation" as const;
 ...
 * @see https://schema.org/StatisticalPopulation
 */
export interface SchemaOrg_StatisticalPopulation extends SchemaOrg_Intangible {
    /**
