 ...
 * @see https://schema.org/PaymentCard
 */
export interface SchemaOrg_PaymentCard extends SchemaOrg_PaymentMethod, SchemaOrg_FinancialProduct {
    /**
     ...
     */
    monthlyMinimumRepaymentAmount?: Array<SchemaOrg_MonetaryAmount | SchemaOrg_Number>;
}
