...
import type { SchemaOrg_RepaymentSpecification } from "./SchemaOrg_RepaymentSpecification.ts";
 ...
 */
export const SCHEMA_ORG_LoanOrCredit =
  "https://schema.org/LoanOrCredit" as const;
