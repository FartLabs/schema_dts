 ...
 */
export const SCHEMA_ORG_EngineSpecification = "https://schema.org/EngineSpecification" as const;

/**
 * Information about the engine of the vehicle. A vehicle can have multiple engines represented by multiple engine specification entities.
 * @see https://schema.org/EngineSpecification
 */
export interface SchemaOrg_EngineSpecification extends SchemaOrg_StructuredValue {
    /**
     ...
     */
    engineType: Array<SchemaOrg_QualitativeValue | SchemaOrg_URL | SchemaOrg_Text>;
    /**
