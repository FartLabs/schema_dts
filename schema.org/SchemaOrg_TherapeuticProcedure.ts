 ...
 */
export const SCHEMA_ORG_TherapeuticProcedure =
  "https://schema.org/TherapeuticProcedure" as const;

/**
 * A medical procedure intended primarily for therapeutic purposes, aimed at improving a health condition.
 * @see https://schema.org/TherapeuticProcedure
 */
export interface SchemaOrg_TherapeuticProcedure
  extends SchemaOrg_MedicalProcedure {
  /**
