 ...
 */
export const SCHEMA_ORG_LymphaticVessel = "https://schema.org/LymphaticVessel" as const;
...
export interface SchemaOrg_LymphaticVessel extends SchemaOrg_Vessel {
     ...
     */
    regionDrained?: Array<SchemaOrg_AnatomicalStructure | SchemaOrg_AnatomicalSystem>;
    /**
