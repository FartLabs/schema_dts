...
import type { SchemaOrg_CorrectionComment } from "./SchemaOrg_CorrectionComment.ts";
...
import type { SchemaOrg_IPTCDigitalSourceEnumeration } from "./SchemaOrg_IPTCDigitalSourceEnumeration.ts";
 ...
 */
export const SCHEMA_ORG_CreativeWork =
  "https://schema.org/CreativeWork" as const;
...
export interface SchemaOrg_CreativeWork extends SchemaOrg_Thing {
   ...
   */
  audio?: Array<
    SchemaOrg_MusicRecording | SchemaOrg_AudioObject | SchemaOrg_Clip
  >;
  /**
   ...
   */
  correction?: Array<
    SchemaOrg_Text | SchemaOrg_CorrectionComment | SchemaOrg_URL
  >;
  /**
   ...
   */
  isBasedOnUrl?: Array<
    SchemaOrg_URL | SchemaOrg_Product | SchemaOrg_CreativeWork
  >;
  /**
