 ...
 */
export const SCHEMA_ORG_VideoGameSeries = "https://schema.org/VideoGameSeries" as const;

/**
 * A video game series.
 * @see https://schema.org/VideoGameSeries
 */
export interface SchemaOrg_VideoGameSeries extends SchemaOrg_CreativeWorkSeries {
    /**
