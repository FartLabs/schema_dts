...
import type { SchemaOrg_DrugClass } from "labs/SchemaOrg_DrugClass.ts";
import type { SchemaOrg_DrugLegalStatus } from "labs/SchemaOrg_DrugLegalStatus.ts";
import type { SchemaOrg_DrugPregnancyCategory } from "labs/SchemaOrg_DrugPregnancyCategory.ts";
import type { SchemaOrg_DrugPrescriptionStatus } from "labs/SchemaOrg_DrugPrescriptionStatus.ts";
import type { SchemaOrg_DrugStrength } from "labs/SchemaOrg_DrugStrength.ts";
import type { SchemaOrg_HealthInsurancePlan } from "labs/SchemaOrg_HealthInsurancePlan.ts";
import type { SchemaOrg_MaximumDoseSchedule } from "labs/SchemaOrg_MaximumDoseSchedule.ts";
...
import type { SchemaOrg_Substance } from "labs/SchemaOrg_Substance.ts";
