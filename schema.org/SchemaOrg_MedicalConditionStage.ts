 ...
 */
export const SCHEMA_ORG_MedicalConditionStage = "https://schema.org/MedicalConditionStage" as const;

/**
 * A stage of a medical condition, such as 'Stage IIIa'.
 * @see https://schema.org/MedicalConditionStage
 */
export interface SchemaOrg_MedicalConditionStage extends SchemaOrg_MedicalIntangible {
    /**
