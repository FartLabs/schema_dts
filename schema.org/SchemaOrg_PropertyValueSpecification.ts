 ...
 */
export const SCHEMA_ORG_PropertyValueSpecification = "https://schema.org/PropertyValueSpecification" as const;

/**
 * A Property value specification.
 * @see https://schema.org/PropertyValueSpecification
 */
export interface SchemaOrg_PropertyValueSpecification extends SchemaOrg_Intangible {
    /**
