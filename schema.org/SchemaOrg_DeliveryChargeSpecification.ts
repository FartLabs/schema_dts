 ...
 */
export const SCHEMA_ORG_DeliveryChargeSpecification = "https://schema.org/DeliveryChargeSpecification" as const;

/**
 * The price for the delivery of an offer using a particular delivery method.
 * @see https://schema.org/DeliveryChargeSpecification
 */
export interface SchemaOrg_DeliveryChargeSpecification extends SchemaOrg_PriceSpecification {
    /**
