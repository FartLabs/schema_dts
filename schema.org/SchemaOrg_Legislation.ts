...
import type { SchemaOrg_LegalForceStatus } from "labs/SchemaOrg_LegalForceStatus.ts";
...
export interface SchemaOrg_Legislation extends SchemaOrg_CreativeWork {
     ...
     */
    legislationJurisdiction: Array<SchemaOrg_AdministrativeArea | SchemaOrg_Text>;
    /**
