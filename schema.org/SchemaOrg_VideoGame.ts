...
import type { SchemaOrg_Game } from "labs/SchemaOrg_Game.ts";
import type { SchemaOrg_GamePlayMode } from "labs/SchemaOrg_GamePlayMode.ts";
import type { SchemaOrg_GameServer } from "labs/SchemaOrg_GameServer.ts";
 ...
 * @see https://schema.org/VideoGame
 */
export interface SchemaOrg_VideoGame extends SchemaOrg_SoftwareApplication, SchemaOrg_Game {
    /**
