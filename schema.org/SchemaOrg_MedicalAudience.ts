 ...
 */
export const SCHEMA_ORG_MedicalAudience = "https://schema.org/MedicalAudience" as const;

/**
 * Target audiences for medical web pages.
 * @see https://schema.org/MedicalAudience
 */
export type SchemaOrg_MedicalAudience = SchemaOrg_Audience & SchemaOrg_PeopleAudience;
