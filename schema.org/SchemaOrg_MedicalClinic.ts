 ...
 */
export const SCHEMA_ORG_MedicalClinic =
  "https://schema.org/MedicalClinic" as const;

/**
 * A facility, often associated with a hospital or medical school, that is devoted to the specific diagnosis and/or healthcare. Previously limited to outpatients but with evolution it may be open to inpatients as well.
 * @see https://schema.org/MedicalClinic
 */
export interface SchemaOrg_MedicalClinic
  extends SchemaOrg_MedicalBusiness, SchemaOrg_MedicalOrganization {
  /**
