 ...
 */
export const SCHEMA_ORG_HealthPlanCostSharingSpecification =
  "https://schema.org/HealthPlanCostSharingSpecification" as const;

/**
 * A description of costs to the patient under a given network or formulary.
 * @see https://schema.org/HealthPlanCostSharingSpecification
 */
export interface SchemaOrg_HealthPlanCostSharingSpecification
