...
import type { SchemaOrg_CarUsageType } from "./SchemaOrg_CarUsageType.ts";
import type { SchemaOrg_Date } from "./SchemaOrg_Date.ts";
import type { SchemaOrg_DriveWheelConfigurationValue } from "./SchemaOrg_DriveWheelConfigurationValue.ts";
import type { SchemaOrg_EngineSpecification } from "./SchemaOrg_EngineSpecification.ts";
...
import type { SchemaOrg_SteeringPositionValue } from "./SchemaOrg_SteeringPositionValue.ts";
...
export interface SchemaOrg_Vehicle extends SchemaOrg_Product {
  ...
  driveWheelConfiguration?: Array<
    SchemaOrg_Text | SchemaOrg_DriveWheelConfigurationValue
  >;
  /**
  ...
  meetsEmissionStandard?: Array<
    SchemaOrg_Text | SchemaOrg_QualitativeValue | SchemaOrg_URL
  >;
  /**
  ...
  vehicleSeatingCapacity?: Array<
    SchemaOrg_Number | SchemaOrg_QuantitativeValue
  >;
  /**
