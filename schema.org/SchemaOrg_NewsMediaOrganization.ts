...
import type { SchemaOrg_AboutPage } from "./SchemaOrg_AboutPage.ts";
 ...
 */
export const SCHEMA_ORG_NewsMediaOrganization =
  "https://schema.org/NewsMediaOrganization" as const;

/**
 * A News/Media organization such as a newspaper or TV station.
 * @see https://schema.org/NewsMediaOrganization
 */
export interface SchemaOrg_NewsMediaOrganization
  extends SchemaOrg_Organization {
  /**
  ...
  missionCoveragePrioritiesPolicy?: Array<
    SchemaOrg_CreativeWork | SchemaOrg_URL
  >;
  /**
