...
import type { SchemaOrg_DDxElement } from "./SchemaOrg_DDxElement.ts";
import type { SchemaOrg_Drug } from "./SchemaOrg_Drug.ts";
import type { SchemaOrg_EventStatusType } from "./SchemaOrg_EventStatusType.ts";
import type { SchemaOrg_MedicalConditionStage } from "./SchemaOrg_MedicalConditionStage.ts";
...
import type { SchemaOrg_MedicalStudyStatus } from "./SchemaOrg_MedicalStudyStatus.ts";
 ...
 */
export const SCHEMA_ORG_MedicalCondition =
  "https://schema.org/MedicalCondition" as const;
...
export interface SchemaOrg_MedicalCondition extends SchemaOrg_MedicalEntity {
   ...
   */
  status?: Array<
    SchemaOrg_Text | SchemaOrg_MedicalStudyStatus | SchemaOrg_EventStatusType
  >;
  /**
