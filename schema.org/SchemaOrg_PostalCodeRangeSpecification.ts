 ...
 */
export const SCHEMA_ORG_PostalCodeRangeSpecification = "https://schema.org/PostalCodeRangeSpecification" as const;

/**
 * Indicates a range of postal codes, usually defined as the set of valid codes between [[postalCodeBegin]] and [[postalCodeEnd]], inclusively.
 * @see https://schema.org/PostalCodeRangeSpecification
 */
export interface SchemaOrg_PostalCodeRangeSpecification extends SchemaOrg_StructuredValue {
    /**
