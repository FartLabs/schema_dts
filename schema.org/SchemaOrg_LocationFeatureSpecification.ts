 ...
 */
export const SCHEMA_ORG_LocationFeatureSpecification =
  "https://schema.org/LocationFeatureSpecification" as const;

/**
 * Specifies a location feature by providing a structured value representing a feature of an accommodation as a property-value pair of varying degrees of formality.
 * @see https://schema.org/LocationFeatureSpecification
 */
export interface SchemaOrg_LocationFeatureSpecification
  extends SchemaOrg_PropertyValue {
  /**
