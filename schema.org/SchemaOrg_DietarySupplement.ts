...
import type { SchemaOrg_RecommendedDoseSchedule } from "labs/SchemaOrg_RecommendedDoseSchedule.ts";
 ...
 */
export const SCHEMA_ORG_DietarySupplement = "https://schema.org/DietarySupplement" as const;

/**
 * A product taken by mouth that contains a dietary ingredient intended to supplement the diet. Dietary ingredients may include vitamins, minerals, herbs or other botanicals, amino acids, and substances such as enzymes, organ tissues, glandulars and metabolites.
 * @see https://schema.org/DietarySupplement
 */
export interface SchemaOrg_DietarySupplement extends SchemaOrg_Substance, SchemaOrg_Product {
    /**
