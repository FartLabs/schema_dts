 ...
 */
export const SCHEMA_ORG_MedicalScholarlyArticle =
  "https://schema.org/MedicalScholarlyArticle" as const;

/**
 * A scholarly article in the medical domain.
 * @see https://schema.org/MedicalScholarlyArticle
 */
export interface SchemaOrg_MedicalScholarlyArticle
  extends SchemaOrg_ScholarlyArticle {
  /**
